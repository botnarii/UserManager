                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            ...
                            <div id="billingAddressForm" style="float: left; border-right: 1px solid #00ff00; width: 500px">
                               <c:choose>
                                   <c:when test="${customer.billingAddress != null}">
                                       <div class="showCurrentAddress">
                                           <table class="currentAddr" style="width: 300px;">
                                               ...
                                               <tr>
                                                   <th style="width: 40%">street: </th><td>${customer.billingAddress.street}</td>
                                               </tr>
                                               <tr>
                                                   <th style="width: 40%">city: </th><td>${customer.billingAddress.city}</td>
                                               </tr>
                                               <tr>
                                                   <th style="width: 40%">state: </th><td>${customer.billingAddress.state}</td>
                                               </tr>
                                               <tr>
                                                   <th style="width: 40%">country: </th><td>${customer.billingAddress.country}</td>
                                               </tr>
                                               <tr>
                                                   <th style="width: 40%">zipcode: </th><td>${customer.billingAddress.zipCode}</td>
                                               </tr>
                                               </tbody>
                                           </table>
                                       </div>
                                       ...
                                       <jsp:include page="editBillingAddress.jsp"/>
                                   </c:when>
                                   <c:otherwise>
                                       <script>
                                           $(document).ready(function(){
