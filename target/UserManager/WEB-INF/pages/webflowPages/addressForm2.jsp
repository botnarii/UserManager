...
<div class="addressBox">
    <div class="slidingDiv" >
        ...
        <form:form commandName="address2" method="POST" enctype="utf8" role="form">
            ...
            <%--<input type="hidden" name="_eventId" value="saveAddress">--%>
            <button type="submit" name="_eventId_register" value="register" class="btn btn-default"><spring:message code="label.user.registration.submit.button"/></button>
        </form:form>
    </div>
</div>
