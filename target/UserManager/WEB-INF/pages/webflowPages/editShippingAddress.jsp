...
<div class="addressBox">
    <div class="slidingDiv" >
        ...
        <form:form commandName="address2" method="POST" enctype="utf8" role="form">
            <form:hidden path="id"/>
            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
            <input type="hidden" name="addressType" value="shipping">
            <div class="row form-group">
                <div id="form-group-Country" class="form-group col-lg-4 col-xs-4">
            ...
            <div class="row form-group">
                <div id="form-group-State" class="form-group col-lg-4 col-xs-4">
            ...
            <div class="row form-group">
                <div id="form-group-City" class="form-group col-lg-4 col-xs-4">
            ...
            <div class="row form-group">
                <div id="form-group-Street" class="form-group col-lg-4 col-xs-4">
            ...
            <div class="row form-group">
                <div id="form-group-ZipCode" class="form-group col-lg-4 col-xs-4">
